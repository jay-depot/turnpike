...
function EndpointController(req, res, body, path) {
  ...
  this.public = {
    ...
    setBody:    function(body) { $this._body = body; },
    ...
    deliver:   function() {
      $this._res.writeHead($this.private._status, $this._headers);
      $this._res.end($this.private._body);
    }
  };
...
EndpointController.extend = function(that) {
  ...
  that.public = controller.public;
  that.protected = controller.protected;
};
